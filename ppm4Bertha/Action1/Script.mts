...
Browser("Search Projects").Page("Project Overview_2").WebEdit("resourcePool").Set "ui" @@ hightlight id_;_Browser("Search Projects").Page("Project Overview 2").WebEdit("resourcePool")_;_script infofile_;_ZIP::ssf6.xml_;_
