...
For row = 18 To nRows ' row 1 is the header row so skip
	print row
	...
	If staffingProfile = 1 Then
		...
		For backToStart = 1 To 5 Step 1
			...
			if Browser("Project Overview").Page("Project Overview").Link("Search Projects").Exist (10) then ' standard hack of having to wait after the object appears @@ hightlight id_;_Browser("Search Projects").Page("Project Overview 2").Link("Search Projects")_;_script infofile_;_ZIP::ssf13.xml_;_
				wait 3
...
Function saveMe
	Browser("Search Projects").Page("Project Overview_2").WebElement("WebElement").Click
